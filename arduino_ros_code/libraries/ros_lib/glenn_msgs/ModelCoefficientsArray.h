#ifndef _ROS_glenn_msgs_ModelCoefficientsArray_h
#define _ROS_glenn_msgs_ModelCoefficientsArray_h
...
namespace glenn_msgs
{
  ...
  class ModelCoefficientsArray : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "glenn_msgs/ModelCoefficientsArray"; };
    virtual const char * getMD5() override { return "254e067eae36e1b2a9eed79ee3db6cdb"; };
